 ...
 */
export default class EncryptedDocument extends Signable {
   ...
   *
   * <code>
   * encryptedDocument = EncryptedDocument.decode({
   *   'data': {},
   *   'meta': {},
   *   'rec_sig': ''
   * })
   ...
   * @param {object} json
   *
   * @return {Promise<EncryptedDocument>}
   */
  static decode(json) {
    let encryptedDocument = new EncryptedDocument(json.meta, json.data, json.rec_sig)
